    ...
    <div class="relative p-6 space-y-4">
      ...
      <div class="flex items-center justify-between">
        ...
        <span class="bg-green-600 text-white px-2 py-1 rounded-md text-sm font-bold">
          ${university.discountPercent}% OFF
        </span>
      </div>

      <div>
        <h4 class="text-gray-900 font-semibold mb-3">${university.description}</h4>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-600">${university.totalStudents} estudantes</span>
          </div>
          ...
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-600">${university.city}</span>
          </div>
          ...
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-600">
              ${university.activePartnership ? 'Parceria ativa' : 'Sem parceria'}
            </span>
          </div>
